...
4. Follow the current phase checklist in `agents/workflows/oneoff.workflow.md` and log reflections in the task spec (record approvals in the Decision & Work Log).
